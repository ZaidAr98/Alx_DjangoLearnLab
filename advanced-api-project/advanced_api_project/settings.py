...
SECRET_KEY = 'django-insecure-xc6^gyhm0#ftm5m(l7m^3858ac(@mslz&qsc#lt800+r-m8b6b'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # Optionally include for session-based auth
    ],
